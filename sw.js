...
// 2. Cache Versioning (Updated to v15 to fix real-time WebChannel stream)
const CACHE_NAME = 'budget-store-v15'; 
...
// 7. Fetch Setup (The PERFECT Sync Fix)
self.addEventListener('fetch', (event) => {
    const url = event.request.url;

    // THE FIX: Absolutely DO NOT intercept Firebase APIs at all.
    // Returning immediately lets the browser handle it natively, keeping the Firestore real-time stream alive!
    ...
    // Core files: Bypass browser cache to ensure instant logic updates
